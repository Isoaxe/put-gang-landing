      ...
      <div className="membership">
        <div className="memb-container memb-left">
          ...
          <ul className="discussion-text">
            <li>
              Access to a three class course teaching the basics of stock
              options trading.
            </li>
          ...
          <p className="discussion-text">
            Gain view-only access to our private discord channel to see buying
            ideas, new content, previously recorded stock classes, and live
            stock discussion in the discord with experienced traders.
          </p>
        ...
        <div className="memb-container memb-right">
          ...
          <p className="discussion-text">
            Everything that comes with "watch" +
          </p>
          <ul className="discussion-text">
            <li>Special Access to interact our private discord channel.</li>
            <li>
              Ability to Join the discussion, ask questions and interact with
              experienced traders.
            </li>
            <li>Ability to join LIVE stock market training classes.</li>
          </ul>
          <p className="discussion-text">
            Access to all "watch" perks plus the ability to ask questions and
